...
try:
   ...
   os.system("python /home/schoi/etl/scripts/pw_building_data_prod.py")

   #Data write to analytics as processed data
   os.system("python /home/schoi/etl/scripts/building_data_analytics.py")
except:
   ...
   message = """From: Linux Box <{0}>\nTo:<{1}>\nSubject: ERROR LOG-FAIL TO WRITE {2}\n\nError Message: {3}.""".format(mf.gmail_id,mf.recip,'prospect_data',error_log)
   try:
