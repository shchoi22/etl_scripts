...
select
  ...
  ,case when showings_clean.application_id is not null and showings.start_time < applications.created_at and date_part('day',showings.start_time-applications.created_at) <= 60
